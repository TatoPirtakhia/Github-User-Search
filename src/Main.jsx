      ...
      <div className={props.dark ? "dark_folowers" : "folowers"}>
        <div className="box">
          <p
            className={
              props.dark
                ? "dark_main_title spaceSmall"
                : "main_Title spaceSmall"
            }
          >
            Repos
          </p>
          <span
            className={
              props.dark ? "dark_numbers spaceBold" : "numbers spaceBold "
            }
          >
      ...
      <div className="footer">
          ...
          <div className="footer_icons">
            <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill={props.dark?"#FFFFFF":"#4b6a9b"}
              />
            </svg>
          </div>
          <p
            className={
              props.user.location != null && props.user.location !== ""
        ...
        <div className="footer_box">
          <div className="footer_icons">
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              <g fill={props.dark?"#FFFFFF":"#4b6a9b"}
              >
        ...
        <div className="footer_box">
          ...
          <a
            ...
            className={props.dark ?"dark_footer_title spaceSmall" :"spaceSmall footer_title"}
            target="_blank"
          >
            @github
          </a>
